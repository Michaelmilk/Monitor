      ...
      '$timeout', function ($timeout) {
          return {
              ...
              template:
                "<ul class=\"nav nav-list nav-pills nav-stacked abn-tree\">\n  " +
                    "<li ng-repeat=\"row in tree_rows | filter:{visible:true} track by row.branch.uid\" " +
                        ...
                        "class=\"abn-tree-row\">" +
                        "<a ng-click=\"user_clicks_branch(row.branch)\" ng-class=\"{'_bk-alarm': row.branch.status == 2}\">" +
              ...
              link: function (scope, element, attrs) {
                  ...
                  /**
                   * add new value by michaelmilk
                   */
                  var isFirstTimeLoadTree = false;//when click branch, initialize selection code won't be implement in on_treeData_change
                  ...
                  on_treeData_change = function () {
                      ...
                      * 
                      */
                      if (attrs.initialSelection != null && !isFirstTimeLoadTree) {
                          for_each_branch(function (b) {
                              if (b.label === attrs.initialSelection) {
                                  isFirstTimeLoadTree = true;
                                  return $timeout(function () {
                  ...
                  if (scope.treeControl != null) {
                      if (angular.isObject(scope.treeControl)) {
                          ...
                          /**
                           * provide new feature by michaelmilk
                           * get the brabch through label name
                           * @param {} label 
                           * @returns branch
                           */
                          tree.getBranch = function (label) {
                              var branch;
                              for_each_branch(function (b) {
                                  if (b.label === label) {
                                      //b.status = 2;
